...
class BlackjackLayout(BoxLayout):
    ...
    def hit(self):
        if self.user_card3.card_value == 0:
            ...
            self.blank.text = str(self.my_hand[0][2] + self.my_hand[1][2] + self.my_hand[2][2])
            ...
            self.blank.text = str(self.my_hand[0][2] + self.my_hand[1][2] + self.my_hand[2][2] + self.my_hand[3][2])
            ...
            self.blank.text = str(self.my_hand[0][2] + self.my_hand[1][2] + self.my_hand[2][2] + self.my_hand[3][2] + self.my_hand[4][2])
